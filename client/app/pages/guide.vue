  ...
  <div class="mx-auto max-w-3xl pb-12">
    ...
    <div v-if="activeTab === 'wiki'" class="flex flex-col gap-6">
      ...
      <section class="rounded-xl border border-gray-700/50 bg-gray-800/40 p-5">
        ...
        <div class="flex flex-wrap gap-2 mb-3">
          ...
          <span class="rounded bg-gray-700 px-2 py-1 text-xs"><span class="text-blue-400">Rare</span> <span class="font-bold text-white">34%</span></span>
          <span class="rounded bg-gray-700 px-2 py-1 text-xs"><span class="text-purple-400">Épique</span> <span class="font-bold text-white">5.5%</span></span>
    ...
    <div v-if="activeTab === 'patchnotes'" class="flex flex-col gap-4">
      ...
      <article class="rounded-xl border-2 border-red-500/60 bg-gradient-to-br from-red-900/30 to-amber-900/20 p-5">
        ...
        <h3 class="mb-3 text-xl font-black text-red-300">v2.0.0 — Générations 5-9 & Avatars — 10 Mars 2026</h3>

        <p class="mb-4 text-sm text-gray-300 italic">
          {{ t('Mise à jour massive ! 5 nouvelles régions (Unys → Paldea), photos de profil, récompense Maître Pokédex et bien plus !', 'Massive update! 5 new regions (Unova → Paldea), profile avatars, Pokédex Master reward and much more!') }}
        </p>
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <ul class="space-y-1 text-sm text-gray-300 list-disc list-inside pl-2">
              ...
              <li>{{ t('Visible partout : sidebar, classements, admin', 'Visible everywhere: sidebar, leaderboards, admin') }}</li>
      ...
      <article class="rounded-xl border border-amber-500/50 bg-amber-900/20 p-5">
        ...
        <div class="space-y-4">
          <div>
            ...
            <ul class="space-y-1 text-sm text-gray-300 list-disc list-inside pl-2">
              <li>{{ t('Taux de drop ajustés : Légendaire 0.5%, Épique 5.5%, Rare 34%, Commun 60%', 'Drop rates adjusted: Legendary 0.5%, Epic 5.5%, Rare 34%, Common 60%') }}</li>
