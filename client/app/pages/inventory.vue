    ...
    <div>
      ...
      <div class="grid grid-cols-3 gap-2 sm:grid-cols-6">
        <div
          ...
          :key="slot"
          class="flex h-48 flex-col items-center justify-center gap-1.5 rounded-xl border bg-gray-800 py-2 transition-all duration-200"
          :class="[
        ...
        >
          <template v-if="inventory.team.find((p) => p.teamSlot === slot)">
            <PokemonSprite
              ...
              class="pointer-events-none h-16 w-16 select-none"
            />
