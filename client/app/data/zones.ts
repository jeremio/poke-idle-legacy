...
export const GENERATIONS: Generation[] = [
    ...
    zones: [
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'cynthia',
          team: [
            { nameFr: 'Spiritomb', nameEn: 'Spiritomb', slug: 'spiritomb', level: 58 },
            { nameFr: 'Lockpin', nameEn: 'Lopunny', slug: 'lopunny', level: 57 },
            { nameFr: 'Lucario', nameEn: 'Lucario', slug: 'lucario', level: 58 },
            { nameFr: 'Blizzaroi', nameEn: 'Abomasnow', slug: 'abomasnow', level: 57 },
  ...
  {
    id: 8,
    nameFr: 'Génération VIII',
    nameEn: 'Generation VIII',
    regionFr: 'Galar',
    regionEn: 'Galar',
    zones: [
      {
        ...
        boss: {
          ...
          slug: 'milo',
          team: [
            { nameFr: 'Blancoton', nameEn: 'Eldegoss', slug: 'eldegoss', level: 12 },
            { nameFr: 'Tournicoton', nameEn: 'Gossifleur', slug: 'gossifleur', level: 13 },
            { nameFr: 'Moumouflon', nameEn: 'Dubwool', slug: 'dubwool', level: 14 },
          ],
          timerSeconds: 30,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'nessa',
          team: [
            { nameFr: 'Torgamord', nameEn: 'Drednaw', slug: 'drednaw', level: 16 },
            { nameFr: 'Hastacuda', nameEn: 'Barraskewda', slug: 'barraskewda', level: 17 },
            { nameFr: 'Nigosier', nameEn: 'Cramorant', slug: 'cramorant', level: 18 },
          ],
          timerSeconds: 30,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'kabu',
          team: [
            { nameFr: 'Scolocendre', nameEn: 'Centiskorch', slug: 'centiskorch', level: 20 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'bea',
          team: [
            { nameFr: 'Krakos', nameEn: 'Grapploct', slug: 'grapploct', level: 24 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'opal',
          team: [
            { nameFr: 'Sorcilence', nameEn: 'Hatterene', slug: 'hatterene', level: 28 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'gordie',
          team: [
            { nameFr: 'Monthracite', nameEn: 'Coalossal', slug: 'coalossal', level: 32 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'piers',
          team: [
            { nameFr: 'Roublenard', nameEn: 'Thievul', slug: 'thievul', level: 36 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'raihan',
          team: [
            { nameFr: 'Duralugon', nameEn: 'Duraludon', slug: 'duraludon', level: 39 },
            { nameFr: 'Pomdrapi', nameEn: 'Flapple', slug: 'flapple', level: 40 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'marnie',
          team: [
            { nameFr: 'Morpeko', nameEn: 'Morpeko', slug: 'morpeko', level: 43 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'bede',
          team: [
            { nameFr: 'Sorcilence', nameEn: 'Hatterene', slug: 'hatterene', level: 46 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'hop',
          team: [
            { nameFr: 'Corvaillus', nameEn: 'Corviknight', slug: 'corviknight', level: 49 },
            { nameFr: 'Pachyradjah', nameEn: 'Copperajah', slug: 'copperajah', level: 50 },
      ...
      {
        id: 12,
        nameFr: 'Macro Cosmos — Shehroz',
        nameEn: 'Macro Cosmos — Rose',
        types: ['steel', 'poison'],
        wild: [
        ...
        boss: {
          ...
          slug: 'rose',
          team: [
            { nameFr: 'Pachyradjah', nameEn: 'Copperajah', slug: 'copperajah', level: 53 },
            { nameFr: 'Éthernatos', nameEn: 'Eternatus', slug: 'eternatus', level: 54 },
      ...
      },
      {
        id: 13,
        nameFr: 'Maître — Tarak',
        nameEn: 'Champion — Leon',
        types: ['fire', 'water', 'grass', 'dragon', 'ghost'],
        wild: [
        ...
        boss: {
          ...
          slug: 'leon',
          team: [
            { nameFr: 'Corvaillus', nameEn: 'Corviknight', slug: 'corviknight', level: 55 },
            { nameFr: 'Lanssorien', nameEn: 'Dragapult', slug: 'dragapult', level: 56 },
            { nameFr: 'Gorythmic', nameEn: 'Rillaboom', slug: 'rillaboom', level: 57 },
            { nameFr: 'Pyrobut', nameEn: 'Cinderace', slug: 'cinderace', level: 58 },
  ...
  {
    id: 9,
    nameFr: 'Génération IX',
    nameEn: 'Generation IX',
    regionFr: 'Paldea',
    regionEn: 'Paldea',
    zones: [
      {
        ...
        boss: {
          ...
          slug: 'katy',
          team: [
            { nameFr: 'Filentrappe', nameEn: 'Spidops', slug: 'spidops', level: 12 },
            { nameFr: 'Gambex', nameEn: 'Lokix', slug: 'lokix', level: 13 },
            { nameFr: 'Tissenboule', nameEn: 'Tarountula', slug: 'tarountula', level: 14 },
          ],
          timerSeconds: 30,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'brassius',
          team: [
            { nameFr: 'Olivado', nameEn: 'Dolliv', slug: 'dolliv', level: 16 },
            { nameFr: 'Scovilain', nameEn: 'Scovillain', slug: 'scovillain', level: 17 },
            { nameFr: 'Arboliva', nameEn: 'Arboliva', slug: 'arboliva', level: 18 },
          ],
          timerSeconds: 30,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'iono',
          team: [
            { nameFr: 'Ampibidou', nameEn: 'Bellibolt', slug: 'bellibolt', level: 20 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'kofu',
          team: [
            { nameFr: 'Triopikeau', nameEn: 'Wugtrio', slug: 'wugtrio', level: 24 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'larry',
          team: [
            { nameFr: 'Fragroin', nameEn: 'Oinkologne', slug: 'oinkologne', level: 28 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'ryme',
          team: [
            { nameFr: 'Tomberro', nameEn: 'Houndstone', slug: 'houndstone', level: 32 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'tulip',
          team: [
            { nameFr: 'Cléopsytra', nameEn: 'Espathra', slug: 'espathra', level: 36 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'grusha',
          team: [
            { nameFr: 'Balbalèze', nameEn: 'Cetitan', slug: 'cetitan', level: 39 },
            { nameFr: 'Cryodo', nameEn: 'Arctibax', slug: 'arctibax', level: 40 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'rika',
          team: [
            { nameFr: 'Terraiste', nameEn: 'Clodsire', slug: 'clodsire', level: 43 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'poppy',
          team: [
            { nameFr: 'Forgelina', nameEn: 'Tinkaton', slug: 'tinkaton', level: 46 },
      ...
      },
      {
        ...
        boss: {
          ...
          slug: 'hassel',
          team: [
            { nameFr: 'Glaivodo', nameEn: 'Baxcalibur', slug: 'baxcalibur', level: 53 },
            { nameFr: 'Motorizard', nameEn: 'Cyclizar', slug: 'cyclizar', level: 54 },
      ...
      {
        id: 13,
        nameFr: 'Maîtresse — Alisma',
        nameEn: 'Champion — Geeta',
        types: ['normal', 'dark', 'fighting', 'dragon', 'steel'],
        wild: [
